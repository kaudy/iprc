																...
																<td class="pad">
																	<div style="font-family:sans-serif">
																		<div class
																			...
																			<p
																				style="margin:0;font-size:14px;text-align:center;mso-line-height-alt:16.8px">
																				<span style="font-size:26px;"><strong>Ativação do Usuario</strong></span>
																			</p>
																		</div>
																	</div>
																</td>
																	...
																	<div style="font-family:sans-serif">
																		<div class
																			...
																			<p
																				style="margin:0;font-size:14px;text-align:center;mso-line-height-alt:16.8px">
																				<span style="font-size:16px;">
																					Um novo usuário na plataforma iPRC foi criado com seu email.
																				</span>
																			</p>
																		</div>
																	</div>
																	...
																	<div style="font-family:sans-serif">
																		<div class
																			...
																			<p
																				style="margin:0;font-size:14px;text-align:center;mso-line-height-alt:16.8px">
																				<span style="font-size:16px;">
																					Para efetuar a ativação e a troca de senha clique no botão a baixo
																				</span>
																			</p>
																		</div>
																	</div>
																	...
																	<div style="font-family:Tahoma,Verdana,sans-serif">
																		<div class
																			...
																			<p
																				style="margin:0;font-size:14px;text-align:center;mso-line-height-alt:16.8px">
																				<span style="font-size:16px;">
																				Caso não tenha conhecimento do novo usuário, por favor nos informe!</span>
																			</p>
																		</div>
																	</div>
																</td>
