							...
							<tbody>
								<tr>
									<td>
										...
										style="mso-table-lspace:0;mso-table-rspace:0;background-color:#fff;color:#000;width:750px;margin:0 auto" width="750">
											<tbody>
												<tr>
																...
																<td class="pad" style="width:100%">
																	<div class="alignment" align="center"
																		...
																		<div style="max-width:180px"><img
																				src="https://d15k2d11r6t6rl.cloudfront.net/public/users/Integrators/0db9f180-d222-4b2b-9371-cf9393bf4764/0bd8b69e-4024-4f26-9010-6e2a146401fb/Reset%20Password%2002/rp-02-image.png"
																...
																<td class="pad">
																	<div style="font-family:sans-serif">
																		<div class
																			...
																			<p
																				style="margin:0;font-size:14px;text-align:center;mso-line-height-alt:16.8px">
																				<span style="font-size:26px;"><strong>Alteração de senha</strong></span>
																			</p>
																		</div>
																	</div>
																</td>
																	...
																	<div style="font-family:sans-serif">
																		<div class
																			...
																			<p
																				style="margin:0;font-size:14px;text-align:center;mso-line-height-alt:16.8px">
																				<span style="font-size:16px;">
																					Nós recebemos uma solicitação para reset de senha!
																				</span>
																			</p>
																		</div>
																	</div>
																	...
																	<div style="font-family:sans-serif">
																		<div class
																			...
																			<p
																				style="margin:0;font-size:14px;text-align:center;mso-line-height-alt:16.8px">
																				<span style="font-size:16px;">
																					Para efetuar a troca de senha clique no botão a baixo
																				</span>
																			</p>
																		</div>
																	</div>
														...
														<table class="button_block block-1" width="100%" border="0"
															...
															<tr>
																<td class="pad" style="text-align:center">
																	<div class="alignment" align="center">
																		<a href="{$dados_template->link_ativacao}" target="_blank"
																	...
																	<div style="font-family:Tahoma,Verdana,sans-serif">
																		<div class
																			...
																			<p
																				style="margin:0;font-size:14px;text-align:center;mso-line-height-alt:16.8px">
																				<span style="font-size:16px;">
																				Se você não solicitou alteração de senha, por favor nos informe</span>
																			</p>
																		</div>
																	</div>
																</td>
