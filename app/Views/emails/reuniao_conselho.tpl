...
<html lang="pt-BR">
	<head>
		...
		<title>iPRC - Recuperar Senha</title>
	...
	<body style="background-color:#e9e9e9;margin:0;padding:0;-webkit-text-size-adjust:none;text-size-adjust:none">
		<table class="nl-container" width="100%" border="0" cellpadding="0" cellspacing="0" role="presentation"
			style="mso-table-lspace:0;mso-table-rspace:0;background-color:#e9e9e9">
			<tbody>
				<tr>
					<td>
								...
								<tr>
									<td>
										<table class="row-content stack" align="center" border="0" cellpadding="0"
											...
											style="mso-table-lspace:0;mso-table-rspace:0;background-color:#fff;color:#000;width:750px;margin:0 auto"
											width="750">
											<tbody>
												<tr>
															...
															<tr>
																<td class="pad">
																	<div style="font-family:sans-serif">
																		<div class
																			style="font-size:14px;font-family:Roboto,Tahoma,Verdana,Segoe,sans-serif;mso-line-height-alt:16.8px;color:#555;line-height:1.2">
																			<p
																				style="margin:0;font-size:14px;text-align:center;mso-line-height-alt:16.8px">
																				<span style="font-size:26px;color:#000000;">iPRC</span>
																			</p>
																		</div>
																	</div>
																</td>
							...
							<tbody>
								<tr>
									<td>
										<table class="row-content stack" align="center" border="0" cellpadding="0"
											cellspacing="0" role="presentation"
											style="mso-table-lspace:0;mso-table-rspace:0;background-color:#fff;border-radius:0;color:#000;width:750px;margin:0 auto"
											width="750">
											<tbody>
												<tr>
													<td class="column column-1" width="100%"
														...
														<table class="text_block block-1" width="100%" border="0"
															...
															<tr>
																<td class="pad">
																	<div style="font-family:sans-serif">
																		<div class
																			style="font-size:14px;font-family:Roboto,Tahoma,Verdana,Segoe,sans-serif;mso-line-height-alt:16.8px;color:#00448b;line-height:1.2">
																			<p
																				style="margin:0;font-size:14px;text-align:center;mso-line-height-alt:16.8px">
																				<span style="font-size:26px;"><strong>Edital de Convocação</strong></span>
																			</p>
																		</div>
																	</div>
																</td>
																		...
																		<div class
																			...
																			<p
																				...
																				<span style="font-size:16px;">
																					Olá Sra(Sr) Conselheira(o) {$payload->nome},
																				</span>
																			</p>
																		</div>
																	</div>
																		...
																		<div class
																			...
																			<p style="margin:0;font-size:14px;text-align:center;mso-line-height-alt:16.8px">
																				<span style="font-size:16px;text-align:center">
																					Encaminhamos o Edital de Convocação para a Reunião Extraordinária, conforme detalhado abaixo.
																				</span>
																			</p>
																			<div style="margin:40px;font-size:14px;mso-line-height-alt:16.8px">
																				<p style="margin:10px;font-size:14px;text-align:center;mso-line-height-alt:16.8px">
																					<span style="font-size:16px;">
																						{$payload->descricao}
																					</span>
																				</p>
																	...
																	<div style="font-family:sans-serif">
																		<div class
																			...
																			<p
																				style="margin:0;font-size:14px;text-align:center;mso-line-height-alt:16.8px">
																				<span style="font-size:16px;">
																					Para acessar o edital na integra clique no botão a baixo ou pelo site <a href="https://paranaclube.com.br/deliberativo/">paranaclube.com.br</a>.
																				</span>
																			</p>
																		</div>
																	</div>
							...
							<tbody>
								<tr>
									<td>
										<table class="row-content stack" align="center" border="0" cellpadding="0"
											cellspacing="0" role="presentation"
											style="mso-table-lspace:0;mso-table-rspace:0;color:#000;width:750px;margin:0 auto"
											width="750">
											<tbody>
												<tr>
													<td class="column column-1" width="100%"
														...
														<table class="text_block block-1" width="100%" border="0"
															...
															<tr>
																<td class="pad">
																	<div style="font-family:sans-serif">
																		<div class
																			style="font-size:12px;font-family:Roboto,Tahoma,Verdana,Segoe,sans-serif;mso-line-height-alt:14.399999999999999px;color:#555;line-height:1.2">
																			<p
																				style="margin:0;font-size:14px;text-align:center;mso-line-height-alt:16.8px">
																				<span
																					style="font-size:12px;"><strong>iPRC</strong></span>
																			</p>
																			<p
																				style="margin:0;font-size:14px;text-align:center;mso-line-height-alt:16.8px">
																				<span style="font-size:12px;">Paraná
																					Clube</span>
																			</p>
																		</div>
																	</div>
