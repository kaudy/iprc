	...
	<div class="container">
		<form method="post" id="formulario">
			...
			<ul class="nav nav-tabs" id="myTab" role="tablist">
				...
				<button class="nav-link active" id="home-tab" data-bs-toggle="tab" data-bs-target="#votos" type="button" role="tab" aria-controls="votos" aria-selected="true">Votos</button>
				</li>
				<li class="nav-item" role="presentation">
							...
							<table class="table table-sm table-responsive table-striped">
								<thead class="thead-light">
									<tr>
										...
										<th scope="col">Qtde. Votos</th>
									</tr>
								</thead>
								<tbody>
									{foreach from=$resultado_opcoes item=opcao}
										<tr>
											<td scope="row">
												{$opcao@iteration}
											</td>
