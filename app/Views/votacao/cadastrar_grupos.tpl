...
{block name=main}
	...
	<div class="container">
		...
		<form class="was-validated" method="post" onsubmit="">
			...
			<div style="height: 1px;background-color:grey"></div>
			<br>
			<a class="btn btn-sm btn-voltar" href="{url_to('votacao_cadastar_opcoes', $votacao->id)}">Voltar</a>
			<a class="btn btn-sm btn-cadastrar" href="{url_to('votacao_cadastar_fiscais', $votacao->id)}">Próximo >></a>
		</form>
	</div>
{/block}